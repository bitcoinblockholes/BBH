The following is a list of assets used in the bitcoinblockholes source and their proper attribution.
...
### Info
* Designer: md2k7
* Site: https://bitcoinblockholestalk.org/index.php?topic=15276.0
...
### Info
* Designer: Jonas Schnelli (based on the original bitcoinblockholes logo from Bitboy)
* License: MIT
